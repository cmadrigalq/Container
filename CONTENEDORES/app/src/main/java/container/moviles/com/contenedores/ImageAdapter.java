...
//Hay que implementar: getCount(), getItem(), getItemId(), getView() que son heredados de la clase adapter
public class ImageAdapter extends BaseAdapter {
    ...
    public int getCount() {// devuelve el número de elementos que se introducen en el adapter
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            imageView.setLayoutParams(new GridView.LayoutParams(290, 300));// ancho
            // y alto
    ...
    private Integer[] mThumbIds = { R.drawable.bola, R.drawable.bosu,
            R.drawable.ktl, R.drawable.lad, R.drawable.liga,
            R.drawable.mat, R.drawable.trx };
}